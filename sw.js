...
const CACHE = "3d-printing-business-v63";
const ASSETS = [
  "./",
  "index.html",
  "manifest.webmanifest",
  "icon.svg",
  "assets/vendor/flatpickr/flatpickr.min.css?v=63",
  "assets/vendor/flatpickr/flatpickr.min.js?v=63",
  "assets/vendor/flatpickr/zh.js?v=63",
  "assets/style.css?v=63",
  "assets/store.js?v=63",
  "assets/app.js?v=63"
];
